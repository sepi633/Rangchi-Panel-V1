...
نمایندگی ها           </p>
        ...
        <FormAssistance   :is-new="isNew"  :form-data="selected" v-model="openFormModal" @reload="loadData"/>
        <FormDelete :route="'/api/Assistance/Assistance'" formTitle="نقش" @reload="loadData" :selectedId="selected.id" v-model="openDeleteModal"/> 
        <template #footer>
