<template>
  <div class=" p-6 sm:p-10 space-y-6">
    <UCard>
      ...
      <FormDelete :route="'/api/contactusGroup/contactusGroup'" formTitle="گروه های ارتبار با ما" @reload="loadData" :selectedId="selected.id"
...
const {
  public: { contactusGroupcategoryId },
} = useRuntimeConfig();
...
const {sortBy,pageFrom,pageTo,loadData}=useTable('/api/contactusGroup/contactusGroups',sort,filter)
...
const Actions = (row) => [
  [{
    ...
    click: () => navigateTo('/contactusGroup/insert' + row.id)
  }],
  [{
    label: 'حذف',
