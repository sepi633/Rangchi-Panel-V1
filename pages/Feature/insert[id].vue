                ...
                <div class="acardeon content-box">
                    ...
                    <div class="body-box flex flex-wrap p-2 items-start hidden">
                        ...
                        <div class="input-box flex flex-col p-1 w-1/3 ">
                            ...
                            <select class="bg-white border p-1" name="" id="" v-model="newFeature.languageId">
                                <option value="" >انتخاب کنید</option>
                                <option value="1" > فارسی</option>
                                <option value="2" > انگلیسی</option>
                                <option value="3" > روسی</option>
                            </select>
                        </div>
                        <div class="input-box flex flex-col p-1 w-1/3 ">
                        ...
                        <div class="input-box flex flex-col lg:w-2/6 p-1">
                            ...
                            <div class="flex justify-start items-center pt-3">
                                <input class="border   mx-2" type="radio" :checked="newFeature.active == false" name="active" id="r3"
                                    @change="newFeature.active = false">
                                <label for="r3">{{  $t('notActive') }}</label>
                                <input class="border  mx-2" type="radio" :checked="newFeature.active == true" name="active" id="r4"
                                    @change="newFeature.active = true">
                        ...
                        <!-- <div class="input-box flex flex-col lg:w-2/6 p-1">
                            ...
                            <div class="flex justify-start items-center pt-3">
                                <input class="border   mx-2" type="radio" :checked="newFeature.hide ==false" name="hide" id="r5"
                                    @change="newFeature.hide = false">
                                <label for="r5">{{ $t('active') }}</label>
                                <input class="border  mx-2" type="radio" :checked="newFeature.hide ==true" name="hide" id="r6"
                                    @change="newFeature.hide = true">
                        ...
                        <div class="input-box flex flex-col lg:w-2/6 p-1">
                            ...
                            <div class="flex justify-start items-center pt-3">
                                <input class="border   mx-2" type="radio" :checked="newFeature.inSearch ==false" name="inSearch" id="r7"
                                    @change="newFeature.inSearch = false">
                                <label for="r7">{{ $t('active') }}</label>
                                <input class="border  mx-2" type="radio" :checked="newFeature.inSearch ==true" name="inSearch" id="r8"
                                    @change="newFeature.inSearch = true">
...
try {
  ...
  console.log("data from detail code");
...
const submitInfo = async (type) => {
    ...
    if(type=='insert'){
        try {
        const headers = useRequestHeaders(['cookie'])
        const insert = await $fetch('/api/feature/feature', {
            method: "POST",
