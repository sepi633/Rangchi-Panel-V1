<template>
    <div class="p-6 sm:p-10 space-y-6">
        <div class="flex flex-wrap">
            ...
            <NuxtLink class="bg-white rounded p-2 border flex justify-center items-center min-h-[100px] cursor-pointer" to="/discountGroup/insertnew">
            ...
            <div class="bg-white rounded p-2 border flex flex-col justify-center items-center min-h-[100px] item-box">
                ...
                <div class="bg-[#1f2937] w-full mt-3 rounded flex p-1 justify-around">
                        <!-- <button @click="getItem(item.id)"> -->
                            <NuxtLink class="flex text-white" :to="`/discountGroup/insert${item?.id}`">
