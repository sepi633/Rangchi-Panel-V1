<template>
  <div class=" p-6 sm:p-10 space-y-6">
    <UCard>
      ...
      <FormDelete :route="'/api/BulkPurchase/BulkPurchase'" formTitle="خرید عمده" @reload="loadData" :selectedId="selected.id"
...
const {sortBy,pageFrom,pageTo,loadData}=useTable('/api/BulkPurchase/BulkPurchases',sort,filter)
...
const Actions = (row) => [
  [{
    ...
    click: () => navigateTo('/BulkPurchase/insert' + row.id)
  }],
  [{
    label: 'حذف',
