<template>
    <div class="flex flex-wrap">
        ...
        <div class="inputgroup w-full lg:w-1/2">
            ...
            <textarea  v-model="categoryDataLang.seoFieldLangDto.summary" name="" id="" cols="30" rows="10"></textarea>
        </div>

        <div class="inputgroup w-full lg:w-1/2">
            <label for=""> توضیحات خلاصه سئو(seoMinDescription)</label>
            <textarea  v-model="categoryDataLang.seoFieldLangDto.seoMinDescription" name="" id="" cols="30" rows="10"></textarea>
...
const getCategoryItem = async (id) => {
    ...
    try {
        ...
        if(data?.list[0]){
            categoryDataLang.value.seoFieldLangDto =( data?.list.find( (item) => item.languageId == 2) ||
             {
          languageId: 2,
          seoH1: "",
          seoMinDescription: "",
