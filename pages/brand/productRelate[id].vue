<template>
    ...
    <div class="file-all relative pt-3">
        <strong> آیتم های کاربردی مربوط به محصول{{ route.params.id }}</strong>
       <div class="flex items-center bg-[#fff] mt-3 h-[40px] px-3 rounded" >
          <input v-model="searchValue" type="text" placeholder="جستجوی آیتم" class="w-full block " @keyup="searchProduct">
