<template>
    <div class="flex flex-wrap">
        ...
        <div class="inputgroup w-full lg:w-1/2">
            ...
            <input type="text" v-model="brandDataLang.seoFieldLangDto.seoPictureAlt">
        </div>
        <div class="inputgroup w-full lg:w-1/2">
            <label for=""> خلاصه</label>
            <textarea  v-model="brandDataLang.seoFieldLangDto.summary" name="" id="" cols="30" rows="10"></textarea>
        </div>

        <div class="inputgroup w-full lg:w-1/2">
            <label for=""> توضیحات خلاصه سئو(seoMinDescription)</label>
            <textarea  v-model="brandDataLang.seoFieldLangDto.seoMinDescription" name="" id="" cols="30" rows="10"></textarea>
...
const getbrandItem = async (id) => {
    ...
    try {
        ...
        if(data?.list){
            brandDataLang.value.seoFieldLangDto = (data?.list.find(
