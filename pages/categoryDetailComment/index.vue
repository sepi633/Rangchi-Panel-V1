      ...
      <template #header>
        <div class="flex justify-between">
          ...
          <div class="flex justify-end">
              ...
              square
              variant="solid"
              to="/categoryDetailComment/report"
              />
          </div>
        </div>
      </template>
...
{{row.text}}
        ...
        <template #pin-data="{ row }">
          <UIcon
            ...
            size="lg"
            :name="row.pin ? 'i-heroicons-check-16-solid'
                : 'i-heroicons-x-mark-16-solid'
            "
          />
        </template>
  ...
  [
    {
      ...
      click: () => navigateTo(`/categoryDetailComment/${row.id}`),
    },
  ],
